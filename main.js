  ...
  if(cooldown.has(command)) {
    ...
    if(command == "deadchat"){
      ...
      const DeadchatResponses = [
        ...
        "ur waifu is cringe",
        "#keepwomenjokes",
        "go check the rules if ur cool",
        "everyone, ping your closest friend",
        "what your favorite slur says about you!",
        "what your favorite mental illness says about you!",
        "ranni is hot",
        "fun fact, most of these topics are made to be bad and piss you guys off, which makes you guys talk about how ass the topics are!",
        "DONT ping kakashi, theyre probably talking to minou",
        "who do you simp for?",
        "remember to go answer QOTD!",
